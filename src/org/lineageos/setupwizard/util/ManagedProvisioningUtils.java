...
public class ManagedProvisioningUtils {
    ...
    private static final String FDROID_REPO_LOCATION = "/product/fdroid/repo";
        ...
        try {
            ...
            try (OutputStream packageInSession = session.openWrite("package", 0, -1);
                 InputStream is = new FileInputStream(
                         context.getString(FDROID_REPO_LOCATION) + File.separator + ORBOT_APK)) {
    ...
    /**
     * Applies a pre-defined safe mode configuration
     *
