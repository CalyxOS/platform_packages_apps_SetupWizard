...
public class ManagedProvisioningUtils {
    ...
    public static boolean isProvisioningAllowed(Context context) {
        ...
        return SetupWizardUtils.isOwner() && provisioningMode != GarlicLevel.STANDARD.ordinal()
                && (provisioningMode == DevicePolicyManager.PROVISIONING_MODE_MANAGED_PROFILE
                ? userManager.getAllProfiles().size() == 1
                : !devicePolicyManager.isDeviceOwnerAppOnAnyUser(BELLIS_PACKAGE));
    }
}
