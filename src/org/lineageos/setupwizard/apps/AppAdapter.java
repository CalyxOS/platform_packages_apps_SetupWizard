...
class AppAdapter extends Adapter<AppViewHolder> {
    ...
    private final SortedList<AppItem> items = new SortedList<>(AppItem.class,
            new Callback<AppItem>() {
        @Override
    ...
    public AppViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View v = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.list_item_app,
                viewGroup, false);
