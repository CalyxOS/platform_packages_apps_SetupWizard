...
class AppItem {
    ...
    AppItem(@Nullable Drawable icon, @Nullable CharSequence name, String packageName,
            String apkName, ArrayList<String> categories, String description, String summary,
            boolean checked) {
        this.icon = icon;
        this.name = name;
